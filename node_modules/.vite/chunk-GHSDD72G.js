  ...
  "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        function pushRootCachePool(root2) {
          var rootCache = root2.pooledCache;
          if (rootCache != null) {
        ...
        function popRootCachePool(root2, renderLanes2) {
          root2.pooledCache = pooledCache;
          if (pooledCache !== null) {
        ...
        function popCachePool(workInProgress2) {
          _suspendedPooledCache = pooledCache;
          pooledCache = prevFreshCacheOnStack.current;
          pop(prevFreshCacheOnStack, workInProgress2);
        }
        ...
        function completeWork(current2, workInProgress2, renderLanes2) {
          ...
          switch (workInProgress2.tag) {
            ...
            case HostRoot: {
              ...
              {
                popRootCachePool(fiberRoot, renderLanes2);
                var previousCache = null;
                if (workInProgress2.alternate !== null) {
                  previousCache = workInProgress2.alternate.memoizedState.cache;
                }
            ...
            case LegacyHiddenComponent: {
              ...
              }
              {
                ...
                if (workInProgress2.alternate !== null && workInProgress2.alternate.memoizedState !== null && workInProgress2.alternate.memoizedState.cachePool !== null) {
                  _previousCache2 = workInProgress2.alternate.memoizedState.cachePool.pool;
                }
                var _cache2 = null;
                ...
                var spawnedCachePool = workInProgress2.updateQueue;
                if (spawnedCachePool !== null) {
                  popCachePool(workInProgress2);
                }
              }
              return null;
            }
            case CacheComponent: {
              {
                ...
                if (workInProgress2.alternate !== null) {
                  _previousCache3 = workInProgress2.alternate.memoizedState.cache;
                }
        ...
        function updateOffscreenComponent(current2, workInProgress2, renderLanes2) {
            ...
            if ((workInProgress2.mode & ConcurrentMode) === NoMode) {
              ...
              if (prevState !== null) {
                ...
                if (prevCachePool !== null) {
                  spawnedCachePool = restoreSpawnedCachePool(workInProgress2, prevCachePool);
                }
              }
              var _nextState2 = {
                baseLanes: NoLanes,
            ...
            if (prevState !== null) {
              _subtreeRenderLanes = mergeLanes(prevState.baseLanes, renderLanes2);
              {
                ...
                if (_prevCachePool !== null) {
                  spawnedCachePool = restoreSpawnedCachePool(workInProgress2, _prevCachePool);
                }
              }
              workInProgress2.memoizedState = null;
            } else {
          ...
          {
            workInProgress2.updateQueue = spawnedCachePool;
          }
          {
            reconcileChildren(current2, workInProgress2, nextChildren, renderLanes2);
            return workInProgress2.child;
        ...
        function unwindWork(workInProgress2, renderLanes2) {
          ...
          switch (workInProgress2.tag) {
            ...
            case HostRoot: {
              {
                var root2 = workInProgress2.stateNode;
                popRootCachePool(root2, renderLanes2);
                var cache = workInProgress2.memoizedState.cache;
                popCacheProvider(workInProgress2);
              }
              popHostContainer(workInProgress2);
        ...
        function completeUnitOfWork(unitOfWork) {
          ...
          do {
            ...
            if ((completedWork.flags & Incomplete) === NoFlags) {
              ...
              var _next = unwindWork(completedWork, subtreeRenderLanes);
              if (_next !== null) {
        ...
        function releaseRootPooledCache(root2, remainingLanes) {
          {
            ...
            if (pooledCacheLanes === NoLanes) {
              var pooledCache2 = root2.pooledCache;
              if (pooledCache2 != null) {
                root2.pooledCache = null;
                releaseCache(pooledCache2);
              }
            }
          }
        }
        ...
        function FiberRootNode(containerInfo, tag, hydrate2, identifierPrefix) {
          this.tag = tag;
        ...
        function createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix) {
          var root2 = new FiberRootNode(containerInfo, tag, hydrate2, identifierPrefix);
        ...
        var ReactVersion = "18.0.0-rc.0-experimental-529dc3ce8-20220124";
        ...
        function createContainer(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix) {
          return createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix);
        }
        ...
        function createRoot(container, options2) {
          ...
          var root2 = createContainer(container, ConcurrentRoot, false, null, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix);
        ...
        function hydrateRoot(container, initialChildren, options2) {
          ...
          var root2 = createContainer(container, ConcurrentRoot, true, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix);
          markContainerAsRoot(root2.current, container);
        ...
        function legacyCreateRootFromDOMContainer(container, forceHydrate) {
          ...
          var root2 = createContainer(container, LegacyRoot, forceHydrate, null, false, false, "");
          markContainerAsRoot(root2.current, container);
          var rootContainerElement = container.nodeType === COMMENT_NODE ? container.parentNode : container;
          listenToAllSupportedEvents(rootContainerElement);
          return root2;
 ...
 */
//# sourceMappingURL=chunk-GHSDD72G.js.map
